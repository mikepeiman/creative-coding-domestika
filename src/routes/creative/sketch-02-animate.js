...
const sketch = ({ context, width, height }) => {
  ...
  for (let i = 0; i < NUM_ARCS; i++) {
    console.log(`🚀 ~ file: sketch-02-animate.js ~ line 40 ~ sketch ~ i`, i)
  ...
  return ({ context, width, height }) => {
    ...
    for (let i = 0; i < arcs.length; i++) {
      ...
      console.log(`🚀 ~ file: sketch-02-animate.js ~ line 54 ~ return ~ radius`, radius)
      slice = math.degToRad(360 / num)
      console.log(`🚀 ~ file: sketch-02-animate.js ~ line 55 ~ return ~ slice`, slice)
      angle = slice * i
      console.log(`🚀 ~ file: sketch-02-animate.js ~ line 56 ~ return ~ angle`, angle)
